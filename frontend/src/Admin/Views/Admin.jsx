...
import { mdiBriefcaseVariantOutline, mdiCurrencyUsd, mdiHelpCircleOutline, mdiPoll } from '@mdi/js';
            ...
            <Grid item xs={12} md={6} lg={4}>
              <Grid container spacing={2}>
                <Grid item xs={6}>
                  <CardStatsVertical
                    stats="$25.6k"
                    icon={<Icon path={mdiPoll} size={1} color="green" />}
                    color="success"
                    trendNumber="+42%"
                    title="Total Profit"
                ...
                <Grid item xs={6}>
                  <CardStatsVertical
                    ...
                    trendNumber="-15%"
                    subtitle="Past Month"
                    icon={<Icon path={mdiCurrencyUsd} size={1} color="red" />}
                  />
                </Grid>
                <Grid item xs={6}>
                  <CardStatsVertical
                    ...
                    icon={<Icon path={mdiBriefcaseVariantOutline} size={1} color="blue" />}
                  />
                </Grid>
                <Grid item xs={6}>
                  <CardStatsVertical
                    ...
                    subtitle="Last Week"
                    title="Sales Queries"
                    icon={<Icon path={mdiHelpCircleOutline} size={1} color="orange" />}
                  />
                </Grid>
              </Grid>
            </Grid>
